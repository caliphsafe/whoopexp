    ...
    <main>
      ...
      <section className="hero">
        <div className="heroCopy">
          ...
          <div className="heroActions">
            ...
            <a href="#notes" className="secondary">Director Notes</a>
          </div>
        </div>
        ...
        <div className="heroVisual">
          ...
          <div className="bandMockup">
            <div className="bandTop"></div>
            <div className="sensor"></div>
            <div className="bandBottom"></div>
          </div>
        </div>
      </section>
      ...
      <section id="opportunity" className="section">
        ...
        <div className="grid three">
          <Card title="WHOOP" text="Performance data, strain, recovery, sleep, behavior, and measurable readiness." />
          <Card title="Calm" text="Meditation, breathwork, sleep stories, emotional regulation, and mental wellness." />
          <Card title="The Space Between" text="A complete recovery system where physical readiness and mental state work together." />
        </div>
      </section>
      ...
      <section id="system" className="section darkPanel">
        ...
        <div className="grid two">
          <Feature number="01" title="Band Collection" text="Recovery Band, Sleep Band, Breath Band, and Focus Band colorways." />
          <Feature number="02" title="Packaging Ritual" text="An unboxing experience that feels quiet, intentional, and premium." />
          <Feature number="03" title="App Integration" text="WHOOP recovery scores connected to Calm-guided meditation, breathwork, and sleep rituals." />
          <Feature number="04" title="Launch Campaign" text="A complete campaign language built around the line: Recovery Has Two Sides." />
        </div>
      </section>
      ...
      <section id="notes" className="section notes">
        ...
        <h2>This collaboration works because it expands what recovery means.</h2>
        <p>
